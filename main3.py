    ...
    try:
        while True:
            ...
            for name, point, conf in zip(filtered_names, filtered_points, filtered_confs):
                ...
                # บังคับล็อกมุมให้ตรงกับพิกัดระนาบปลอดภัยดั้งเดิมของจุดสแกนหน้างาน
                A_deg = ROBOT_A_SCAN    # เท่ากับ -90.0 องศา รอบแกน Z 
                B_deg = ROBOT_B_SCAN    # เท่ากับ 0.0 องศา รอบแกน Y
                C_deg = ROBOT_C_SCAN    # เท่ากับ -180.0 องศา รอบแกน X
